...
public class TopicosController {
    ...
    public Page<TopicoDto> lista(@RequestParam(required = false) 
            String nomeCurso, @PageableDefault
        (sort = "id", direction = Direction.DESC, page = 0, size = 10) 
                    Pageable paginacao) {
        //PAGEABLE  - serve para ordenar em paginas / 
        //pode facilitar recebendo ele direto na URL
